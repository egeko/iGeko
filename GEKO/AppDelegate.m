...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@"HasLaunchedOnce"])
    {
        ...
        [database open];
        [database executeUpdate:@"CREATE TABLE userInfos (id INTEGER  PRIMARY KEY DEFAULT NULL,nom TEXT DEFAULT NULL,prenom TEXT DEFAULT NULL,carteid TEXT DEFAULT NULL,password TEXT DEFAULT NULL)"];
